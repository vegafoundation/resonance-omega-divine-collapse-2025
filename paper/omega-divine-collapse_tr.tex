...
\title{Omega Divine Collapse: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, Omega Divine Collapse'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
\end{abstract}
